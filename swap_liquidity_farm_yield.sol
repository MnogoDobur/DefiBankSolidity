...
contract EthGangSwapBankTest19 {
    ...
    constructor() public {
        usdc = 0xdF2eD12d77ff0ecdEaCc7914bc8733d98Ff48D70;
        bankToken = 0xB1BB496ad23463a5b45c400C929CF89769658DFF;
    ...
    function yieldReadable(address user) public view returns(uint256){
        uint256 time = calculateYieldTotal(user,1)*(10*18);
        return time;
    }
    
    function yieldReadableLocked(address user) public view returns(uint256){
        uint256 time = calculateYieldTotal(user,2)*(10*18);
        return time;
    }
